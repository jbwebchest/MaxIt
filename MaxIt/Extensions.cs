...
namespace MaxIt
{
    public static class Extensions
    {
        ...
        {
            var mx = new ColorMatrix(fadeMatrix) { Matrix33 = Opacity };
            ...
            g.DrawImage(bitmap, new Rectangle(0, 0, bmp.Width, bmp.Height), 0, 0, bitmap.Width, bitmap.Height, GraphicsUnit.Pixel, attributes);
            return bmp;
        }
    }
}
